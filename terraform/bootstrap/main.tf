...
#   terraform apply
#
# Then configure the backend in environments/dev or environments/prod
...
locals {
  # Consistent naming: project-account-purpose (globally unique)
...
resource "aws_s3_bucket" "terraform_state" {
  ...
  # NOTE: No lifecycle prevent_destroy - this is a learning project
  # For production, consider adding: lifecycle { prevent_destroy = true }
