...
# - Lifecycle policies (keep recent, delete old untagged)
# - Image scanning on push
# - Immutable tags (production-grade)
...
# Lifecycle Policies - Keep recent images, clean up old ones
...
# Repository Policy - Allow EKS nodes and GitHub Actions to pull
